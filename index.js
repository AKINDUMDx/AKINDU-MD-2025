...
console.log("CONNECTION AKINDU-MD...🤖");
...
console.log('AKINDU CONNECTED TO WHATSAPP ✅')

let up = `ᴀᴋɪɴᴅᴜ-ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ ❤️

❒ ᴏᴡɴᴇʀ : ᴀᴋɪɴᴅᴜ 

❒ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ :  

ᴇɴᴊᴏʏ ᴀɴᴅ ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛꜱᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ❤️`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/wqp3y9.jpg` }, caption: up })
