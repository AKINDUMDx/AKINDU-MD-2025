...
cmd({
    ...
    try {
        await reply("🔍 Checking for AKINDU-MD updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your AKINDU-MD bot is already up-to-date!");
        }

        await reply("🚀 Updating AKINDU-MD Bot...");
        ...
        const sourcePath = path.join(extractPath, "AKINDU_MD-main");
